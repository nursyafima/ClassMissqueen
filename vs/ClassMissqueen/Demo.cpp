...
void Demo::Render() {
	...
	glUniform3f(lightPosLoc, 0, 100, -10);
...
void Demo::BuildColoredWall()
{
	...
	GLfloat vertices[] = {
		...
		-20.0, -0.5, -12.0, 0, 0, //0
		20.0, -0.5, -12.0 ,5, 0, //1
		20.0, 13.0, -12.0, 5, 3,//2
		-20.0, 13.0, -12.0, 0, 3,//3

		-20.0, -0.5, 12.0, 0, 0,//4
		20.0, -0.5, 12.0 ,5, 0,//5
		20.0, 13.0, 12.0, 5, 3,//6
		-20.0, 13.0, 12.0, 0, 3,//7

		-20.0, -0.5, -12.0, 0, 0,//8
		-20.0, -0.5, 12.0 ,5, 0,//9
		-20.0, 13.0, 12.0, 5, 3,//10
		-20.0, 13.0, -12.0, 0, 3,//11

		20.0, -0.5, -12.0, 0, 0,//12
		20.0, -0.5, 12.0 ,5, 0,//13
		20.0, 13.0, 12.0, 5, 3,//14
		20.0, 13.0, -12.0, 0, 3//15
	};
...
void Demo::BuildColoredTable()
{
	...
	GLfloat vertices[] = {
		...
		//table top
		// top
		-4.5f,  2.4f, 1.5f, 0.0f, 0.0f,  // front top left 0
		4.5f, 2.4f, 1.5f,   1.0f, 0.0f,   // front top right 1
		4.5f, 2.4f, -2.5f, 1.0f, 1.0f,    // back top right 2
		-4.5f,  2.4f, -2.5f, 0.0f, 1.0f,  // back top left 3 
		//bottom
		-4.5f, 2.2f, 1.5f,  0.0f, 0.0f, // front bottom left 4
		4.5f, 2.2f, 1.5f,   0.0f, 1.0f, // front bottom right 5
		4.5f, 2.2f, -2.5f, 1.0f, 1.0f,  // back bottom right 6
		-4.5f, 2.2f, -2.5f, 0.0f, 1.0f,  // back bottom left 7 
		//front
		-4.5f, 2.2f, 1.5f,  0.0f, 0.0f, // front bottom left 8
		4.5f, 2.2f, 1.5f,   0.0f, 1.0f, // front bottom right 9
		4.5f, 2.4f, 1.5f, 1.0f, 1.0f,  // back bottom right 10
		-4.5f, 2.4f, 1.5f, 0.0f, 1.0f,  // back bottom left 11 
		//back
		-4.5f, 2.2f, -2.5f,  0.0f, 0.0f, // front bottom left 12
		4.5f, 2.2f, -2.5f,   0.0f, 1.0f, // front bottom right 13
		4.5f, 2.4f, -2.5f,  1.0f, 1.0f,  // back bottom right 14
		-4.5f, 2.4f, -2.5f, 0.0f, 1.0f,  // back bottom left 15 
		//right
		4.5f, 2.2f, 1.5f,  0.0f, 0.0f, // front bottom left 16
		4.5f, 2.2f, -2.5f,   0.0f, 1.0f, // front bottom right 17
		4.5f, 2.4f, -2.5f,  1.0f, 1.0f,  // back bottom right 18
		4.5f, 2.4f, 1.5f, 0.0f, 1.0f,  // back bottom left 19 
		//left
		-4.5f, 2.2f, 1.5f,  0.0f, 0.0f, // front bottom left 20
		-4.5f, 2.2f, -2.5f,   0.0f, 1.0f, // front bottom right 21
		-4.5f, 2.4f, -2.5f,  1.0f, 1.0f,  // back bottom right 22
		-4.5f, 2.4f, 1.5f, 0.0f, 1.0f,  // back bottom left 23
		...
		//front
		-4.3f, 2.2f, 1.4f, 0.0f, 0.0f, // front top left 32
		-4.1f, 2.2f, 1.4f,  1.0f,  0.0f, // front top right 33
		-4.1f, -0.5f, 1.4f, 1.0f, 1.0f,  // back top right 34
		-4.3f, -0.5f, 1.4f, 0.0f, 1.0f,// back top left 35
		//back
		-4.3f, 2.2f, -2.4f, 0.0f, 0.0f, // front top left 36
		-4.1f, 2.2f, -2.4f,  1.0f,  0.0f, // front top right 37
		-4.1f, -0.5f, -2.4f, 1.0f, 1.0f,  // back top right 38
		-4.3f, -0.5f, -2.4f, 0.0f, 1.0f,// back top left 39
		//left
		-4.3f, 2.2f, 1.4f, 0.0f, 0.0f, // front top left 40
		-4.3f, 2.2f, -2.4f,  1.0f,  0.0f, // front top right 41
		-4.3f, -0.5f, -2.4f, 1.0f, 1.0f,  // back top right 42
		-4.3f, -0.5f, 1.4f, 0.0f, 1.0f,// back top left 43
		//right
		-4.1f, 2.2f, 1.4f, 0.0f, 0.0f, // front top left 44
		-4.1f, 2.2f, -2.4f,  1.0f,  0.0f, // front top right 45
		-4.1f, -0.5f, -2.4f, 1.0f, 1.0f,  // back top right 46
		-4.1f, -0.5f, 1.4f, 0.0f, 1.0f,// back top left 47
		//right leg
		////top
		...
		//front
		4.1f,  2.2f, 1.4f,  0.0f, 0.0f,  // front bottom left 56
		4.3f, 2.2f, 1.4f,  1.0f, 0.0f,  // front bottom right 57
		4.3f, -0.5f, 1.4f, 1.0f, 1.0f,   // back bottom right 58
		4.1f,  -0.5f, 1.4f, 0.0f, 1.0f,  // back bottom left 59
		//back
		4.1f,  2.2f, -2.4f,  0.0f, 0.0f,  // front bottom left 60
		4.3f, 2.2f, -2.4f,  1.0f, 0.0f,  // front bottom right 61
		4.3f, -0.5f, -2.4f, 1.0f, 1.0f,   // back bottom right 62
		4.1f,  -0.5f, -2.4f, 0.0f, 1.0f,  // back bottom left 63
		//left
		4.1f,  2.2f, 1.4f,  0.0f, 0.0f,  // front bottom left 64
		4.1f, 2.2f, -2.4f,  1.0f, 0.0f,  // front bottom right 65
		4.1f, -0.5f, -2.4f, 1.0f, 1.0f,   // back bottom right 66
		4.1f,  -0.5f, 1.4f, 0.0f, 1.0f,  // back bottom left 67
		//right
		4.3f,  2.2f, 1.4f,  0.0f, 0.0f,  // front bottom left 68
		4.3f, 2.2f, -2.4f,  1.0f, 0.0f,  // front bottom right 69
		4.3f, -0.5f, -2.4f, 1.0f, 1.0f,   // back bottom right 70
		4.3f,  -0.5f, 1.4f, 0.0f, 1.0f,  // back bottom left 71
		//front shield
		//top
		-4.1f, 2.2f, 1.4f, 0.0f,  0.0f, // front top left 72
		4.1f, 2.2f, 1.4f,  1.0f, 0.0f, // front top right 73
		4.1f, 2.2f, 1.2f,  1.0f, 1.0f, // back top right 74
		-4.1f, 2.2f, 1.2f, 0.0f, 1.0f, // back top left 75
		//bottom
		-4.1f,  0.2f, 1.4f, 0.0f, 0.0f,   // front bottom left 76
		4.1f, 0.2f, 1.4f,  1.0f, 0.0f,   // front bottom right 77
		4.1f, 0.2f, 1.2f, 1.0f, 1.0f,    // back bottom right 78
		-4.1f,  0.2f, 1.2f, 0.0f, 1.0f,  // back bottom left 79
		//front
		-4.1f, 2.2f, 1.4f, 0.0f, 0.0f,   // front bottom left 80
		4.1f, 2.2f, 1.4f, 1.0f, 0.0f,   // front bottom right 81
		4.1f, 0.2f, 1.4f, 1.0f, 1.0f,    // back bottom right 82
		-4.1f, 0.2f, 1.4f, 0.0f, 1.0f,  // back bottom left 83
		//back
		-4.1f, 2.2f, 1.2f, 0.0f, 0.0f,   // front bottom left 84
		4.1f, 2.2f, 1.2f, 1.0f, 0.0f,   // front bottom right 85
		4.1f, 0.2f, 1.2f, 1.0f, 1.0f,    // back bottom right 86
		-4.1f, 0.2f, 1.2f, 0.0f, 1.0f,  // back bottom left 87
		////left
...
void Demo::BuildColoredBoard()
{
	...
	GLfloat vertices[] = {
		...
		//Pinggir Kiri
		//front
		-7.8f, 3.7f, 11.7f, 0.0f, 0.0f,   // back top right 10
		-7.5f, 4.0f, 11.7f, 1.0f, 0.0f, // back top left 11
		-7.5f, 9.0f, 11.7f, 1.0f, 1.0f,   // front top right 9
		-7.8f, 9.3f, 11.7f, 0.0f, 1.0f,  // front top left 8

		//right
		-7.5f, 9.0f, 11.7f, 0.0f, 0.0f, // front bottom left 12
		-7.5f, 9.0f, 12.0f, 1.0f, 0.0f, // front bottom right 13
		-7.5f, 4.0f, 12.0f, 1.0f, 1.0f, // back bottom right 14
		-7.5f, 4.0f, 11.7f, 0.0f, 1.0f, // back bottom left 15 

		//left
		-7.8f, 9.3f, 12.0f, 0.0f, 0.0f,   // front top right 9
		-7.8f, 9.3f, 11.7f, 1.0f, 0.0f,  // front top left 8
		-7.8f, 3.7f, 11.7f, 1.0f, 1.0f,   // back top right 10
		-7.8f, 3.7f, 12.0f, 0.0f, 1.0f, // back top left 11
		...
		//Pinggir Kanan
		//front
		7.5f, 4.0f, 11.7f, 0.0f, 0.0f,   // back top right 10
		7.8f, 3.7f, 11.7f, 1.0f, 0.0f, // back top left 11
		7.8f, 9.3f, 11.7f, 1.0f, 1.0f,   // front top right 9
		7.5f, 9.0f, 11.7f, 0.0f, 1.0f,  // front top left 8

		//right
		7.8f, 9.3f, 11.7f, 0.0f, 0.0f,  // front top left 16
		7.8f, 9.3f, 12.0f, 1.0f, 0.0f,   // front top right 17
		7.8f, 3.7f, 12.0f, 1.0f, 1.0f, // back top left 19
		7.8f, 3.7f, 11.7f, 0.0f, 1.0f,   // back top right 18 

		//left
		7.5f, 4.0f, 12.0f, 0.0f, 0.0f, // back top left 19
		7.5f, 4.0f, 11.7f, 1.0f, 0.0f,   // back top right 18
		7.5f, 9.0f, 11.7f, 1.0f, 1.0f,  // front top left 16
		7.5f, 9.0f, 12.0f, 0.0f, 1.0f,   // front top right 17
		...
		//Pinggir Atas
		//front
		-7.5f, 9.0f, 11.7f, 0.0f, 0.0f,  // front top left 24
		7.5f, 9.0f, 11.7f, 1.0f, 0.0f, // back top left 27 
		7.8f, 9.3f, 11.7f, 1.0f, 1.0f,   // back top right 26
		-7.8f, 9.3f, 11.7f, 0.0f, 1.0f,   // front top right 25

		//top
		7.8f, 9.3f, 11.7f, 0.0f, 0.0f,   // front top right 25
		-7.8f,  9.3f, 11.7f, 1.0f, 0.0f,  // front top left 24
		-7.8f,  9.3f, 12.0f, 1.0f, 1.0f, // back top left 27 
		7.8f, 9.3f, 12.0f, 0.0f, 1.0f,   // back top right 26

		//bottom
		-7.5f, 9.0f, 12.0f, 0.0f, 0.0f, // back bottom left 31
		7.5f, 9.0f, 12.0f, 1.0f, 0.0f, // back bottom right 30
		7.5f, 9.0f, 11.7f, 1.0f, 1.0f, // front bottom right 29
		-7.5f, 9.0f, 11.7f, 0.0f, 1.0f, // front bottom left 28

		//Pinggir Bawah
		//front
		-7.8f, 3.7f, 11.7f, 0.0f, 0.0f,   // front top right 25
		7.8f, 3.7f, 11.7f, 1.0f, 0.0f, // back top left 27
		7.5f, 4.0f, 11.7f, 1.0f, 1.0f,   // back top right 26
		-7.5f, 4.0f, 11.7f, 0.0f, 1.0f,  // front top left 24

		//top
		7.5f, 4.0f, 11.7f, 0.0f, 0.0f,   // front top right 33
		-7.5f,  4.0f, 11.7f, 1.0f, 0.0f,  // front top left 32
		-7.5f,  4.0f, 12.0f, 1.0f, 1.0f, // back top left 35 
		7.5f, 4.0f, 12.0f, 0.0f, 1.0f,   // back top right 34

		//bottom
		-7.8f, 3.7f, 12.0f, 0.0f, 0.0f, // back bottom left 39
		7.8f, 3.7f, 12.0f, 1.0f, 0.0f, // back bottom right 38
		7.8f, 3.7f, 11.7f, 1.0f, 1.0f, // front bottom right 37
		-7.8f, 3.7f, 11.7f, 0.0f, 1.0f // front bottom left 36
...
void Demo::BuildColoredBoardIn()
{
	...
	GLfloat vertices[] = {
		...
		//Bagian belakang
		//Papan Tulis
		-7.5f, 4.0f, 11.8f, 0.0f, 0.0f, // back bottom right 6
		7.5f, 4.0f, 11.8f, 1.0f, 0.0f, // back bottom left 7
		7.5f, 9.0f, 11.8f, 1.0f, 1.0f, // front bottom right 5
		-7.5f, 9.0f, 11.8f, 0.0f, 1.0f, // front bottom left 4
